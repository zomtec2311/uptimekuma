...
class Job extends Entity {
    ...
    public function __construct() {
        ...
        $this->addType('statusSlug','string');
    ...
    public function setInstanceId(int $v): void {
        $this->instanceId = $v;
        $this->markFieldUpdated('instanceId');
    }

    public function getStatusSlug(): string {
        return (string)$this->statusSlug;
    }

    public function setStatusSlug(string $v): void {
        $this->statusSlug = $v;
        $this->markFieldUpdated('statusSlug');
    }
    ...
    public function setUpdatedAt(int $v): void {
        $this->updatedAt = $v;
